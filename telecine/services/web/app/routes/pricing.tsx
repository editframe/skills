...
const tiers = [
  ...
  },
  {
    ...
    description:
      "Adds cloud infrastructure: remote video storage, streaming playback, and parallel cloud rendering.",
    features: [
      "Everything in Team",
      "Remote video file storage",
...
const comparisonFeatures = [
  {
    name: "Remote video file storage",
    free: false,
    team: false,
    cloud: true,
    enterprise: true,
