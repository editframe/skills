...
- [references/volume.md](references/volume.md) — Volume slider (0–1) with auto-unmute
- [references/mute.md](references/mute.md) — Mute/unmute toggle with slot content
- [references/fullscreen.md](references/fullscreen.md) — Browser fullscreen toggle
- [references/pip.md](references/pip.md) — Picture-in-Picture toggle for video and canvas
- [references/resolution.md](references/resolution.md) — Output dimension presets and custom inputs
