    ...
    <section className="relative py-24 bg-[var(--poster-blue)] text-white overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] opacity-[0.05]">
        <svg viewBox="0 0 100 50" className="w-full h-full">
          {/* Left to right arrow */}
          <path d="M10,20 L40,20" stroke="white" strokeWidth="4" strokeLinecap="round"/>
          <polygon points="40,15 50,20 40,25" fill="white" />
          {/* Right to left arrow */}
          <path d="M90,30 L60,30" stroke="white" strokeWidth="4" strokeLinecap="round"/>
          <polygon points="60,25 50,30 60,35" fill="white" />
          {/* Labels */}
          <text x="5" y="15" fill="white" fontSize="6" fontWeight="bold">CODE</text>
          <text x="75" y="40" fill="white" fontSize="6" fontWeight="bold">VIDEO</text>
        </svg>
      </div>
          ...
          <div className="flex items-center gap-4 mb-6">
            <div className="flex gap-1">
              <div className="w-8 h-8 bg-white flex items-center justify-center">
                <span className="text-[var(--poster-blue)] font-black text-lg">{'<'}</span>
              </div>
