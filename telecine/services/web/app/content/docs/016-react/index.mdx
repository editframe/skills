...
## Understanding Editframe Components

Editframe provides two main categories of React components:

**Core Elements** - These are the building blocks for creating videos:
- `Timegroup`, `Video`, `Audio`, `Image`, `Waveform`, `Captions`, `Text`, etc.
- These define the video composition, timeline, and content

**Editor UI Components** - These are for building video editing interfaces:
- `Preview`, `Workbench`, `Configuration` - Containers for editor layouts
- `TogglePlay`, `Scrubber`, `TimeDisplay` - Playback controls
- `Filmstrip`, `FocusOverlay` - Visual editing aids
- These help you build interactive video editors, not just render videos

You can use Core Elements alone to create videos, or combine them with Editor UI components to build full-featured video editing applications.
