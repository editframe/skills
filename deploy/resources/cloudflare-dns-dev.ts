...
export const editframe_dev_a_0 = new cloudflare.DnsRecord(
  "editframe_dev_a_0",
  {
    zoneId: zoneId,
    name: "editframe.dev",
...
export const www_editframe_dev_a_1 = new cloudflare.DnsRecord(
  "www_editframe_dev_a_1",
  {
    zoneId: zoneId,
...
export const editframe_dev_caa_2 = new cloudflare.DnsRecord(
  "editframe_dev_caa_2",
  {
    zoneId: zoneId,
    name: "editframe.dev",
...
export const editframe_dev_caa_3 = new cloudflare.DnsRecord(
  "editframe_dev_caa_3",
  {
    zoneId: zoneId,
    name: "editframe.dev",
...
export const www_editframe_dev_caa_4 = new cloudflare.DnsRecord(
  "www_editframe_dev_caa_4",
  {
    zoneId: zoneId,
    name: "www.editframe.dev",
    type: "CAA",
...
export const www_editframe_dev_caa_5 = new cloudflare.DnsRecord(
  "www_editframe_dev_caa_5",
  {
    zoneId: zoneId,
    name: "www.editframe.dev",
    type: "CAA",
...
export const collin_box_1_editframe_dev_cname_6 = new cloudflare.DnsRecord(
  "collin_box_1_editframe_dev_cname_6",
  {
    zoneId: zoneId,
...
export const collin_box_2_editframe_dev_cname_7 = new cloudflare.DnsRecord(
  "collin_box_2_editframe_dev_cname_7",
  {
    zoneId: zoneId,
...
export const collin_box_3_editframe_dev_cname_8 = new cloudflare.DnsRecord(
  "collin_box_3_editframe_dev_cname_8",
  {
    zoneId: zoneId,
...
export const collin_box_4_editframe_dev_cname_9 = new cloudflare.DnsRecord(
  "collin_box_4_editframe_dev_cname_9",
  {
    zoneId: zoneId,
...
export const collin_swarm_manager_editrfame_dev_editframe_dev_cname_10 =
  new cloudflare.DnsRecord(
    "collin_swarm_manager_editrfame_dev_editframe_dev_cname_10",
    {
      zoneId: zoneId,
...
export const _acme_challenge_editframe_dev_txt_11 = new cloudflare.DnsRecord(
  "_acme_challenge_editframe_dev_txt_11",
  {
    zoneId: zoneId,
...
export const _acme_challenge_www_editframe_dev_txt_12 =
  new cloudflare.DnsRecord(
    "_acme_challenge_www_editframe_dev_txt_12",
    {
      zoneId: zoneId,
...
export const _dmarc_editframe_dev_txt_13 = new cloudflare.DnsRecord(
  "_dmarc_editframe_dev_txt_13",
  {
    zoneId: zoneId,
...
export const wildcard__domainkey_editframe_dev_txt_14 =
  new cloudflare.DnsRecord(
    "wildcard__domainkey_editframe_dev_txt_14",
    {
      zoneId: zoneId,
...
export const editframe_dev_txt_15 = new cloudflare.DnsRecord(
  "editframe_dev_txt_15",
  {
    zoneId: zoneId,
    name: "editframe.dev",
    type: "TXT",
