...
describe("NestingRulesBehavior", () => {
  ...
  test("div can be nested inside div", () => {
    ...
    expect(behaviorRegistry.canMove("div2", "div1", undefined, state)).toBe(
      true,
    );
  });
  ...
  test("div can be nested inside timegroup", () => {
    ...
    expect(behaviorRegistry.canMove("div1", "tg1", undefined, state)).toBe(
      true,
    );
  });
  ...
  test("timegroup cannot be nested inside div", () => {
    ...
    expect(behaviorRegistry.canMove("tg1", "div1", undefined, state)).toBe(
      false,
    );
  });
  ...
  test("timegroup cannot be nested inside timegroup", () => {
    ...
    expect(behaviorRegistry.canMove("tg2", "tg1", undefined, state)).toBe(
      false,
    );
  });
  ...
  test("text element can be nested inside div", () => {
    ...
    expect(behaviorRegistry.canMove("text1", "div1", undefined, state)).toBe(
      true,
    );
  });
  ...
  test("text element can be nested inside timegroup", () => {
    ...
    expect(behaviorRegistry.canMove("text1", "tg1", undefined, state)).toBe(
      true,
    );
  });
  ...
  test("all element types except timegroup can nest inside div", () => {
    ...
    const state = createState(
      [div1, text1, image1, video1, audio1, div2],
      ["tg1"],
    );
    const tg1 = createElement("tg1", "timegroup", []);
    ...
    expect(behaviorRegistry.canMove("image1", "div1", undefined, state)).toBe(
      true,
    );
    expect(behaviorRegistry.canMove("video1", "div1", undefined, state)).toBe(
      true,
    );
    expect(behaviorRegistry.canMove("audio1", "div1", undefined, state)).toBe(
      true,
    );
    expect(behaviorRegistry.canMove("div2", "div1", undefined, state)).toBe(
      true,
  ...
  test("timegroup can only be at root level", () => {
    ...
    expect(behaviorRegistry.canMove("tg1", "tg2", undefined, state)).toBe(
      false,
    );
  });
});
