...
const testimonials = [
  {
    quote:
      "We went from 'video is too hard' to shipping our first video feature in a week. The instant preview changed how we iterate.",
    name: "Alex Chen",
  ...
  {
    quote:
      "Finally, video development that feels like web development. React components, CSS animations, TypeScript - all the tools I already know.",
    name: "Sarah Kim",
      ...
      {testimonials.map((testimonial, i) => (
        <div key={i} className="relative">
          ...
          <div className="relative bg-white dark:bg-[#111] border-4 border-[var(--ink-black)] dark:border-white p-8">
            {/* Large quote mark */}
            <div
              className="text-[120px] font-black leading-none -mt-8 -mb-12 opacity-10"
            ...
            <div className="flex items-center gap-4 pt-6 border-t-2 border-[var(--ink-black)] dark:border-white">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--warm-gray)] uppercase tracking-wide">
