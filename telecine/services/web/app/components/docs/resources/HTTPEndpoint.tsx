...
export const HTTPPayload = ({ docName }: { docName: string }) => {
  ...
  if (!docItem) return <p className="text-red-600 dark:text-red-400">No doc item found for {docName}</p>;
  return (
    <div className="my-4">
      <div className="inline-flex items-center gap-2 mb-3">
        <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Request Body</span>
      </div>
...
export const HTTPResponse = ({ docName }: { docName: string }) => {
  ...
  return (
    <div className="my-4">
      <div className="inline-flex items-center gap-2 mb-3">
        <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400 uppercase tracking-wide">Response</span>
      </div>
      <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
        <ShowDeclaration declaration={docItem} />
      </div>
