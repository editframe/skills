          ...
          <div className="p-6">
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-start gap-3 pb-4 border-b border-rule last:border-0 last:pb-0">
                  ...
                  <div>
                    <p className="font-bold text-sm uppercase tracking-wide mb-0.5">{item.title}</p>
            ...
            <div className="mt-6 pt-4 border-t-2 border-[var(--ink-black)] dark:border-white">
              <p className="text-sm font-bold uppercase tracking-wider">
                Timeline: <span className="text-[var(--poster-red)]">2-4 weeks</span>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="relative">
        ...
        <div className="relative bg-white dark:bg-[#111] border-4 border-[var(--ink-black)] dark:border-white overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="mt-6 pt-4 border-t-2 border-[var(--ink-black)] dark:border-white">
              <p className="text-sm font-bold uppercase tracking-wider">
                Timeline: <span className="text-[var(--poster-blue)]">2-4 hours</span>
              </p>
            </div>
          </div>
        </div>
