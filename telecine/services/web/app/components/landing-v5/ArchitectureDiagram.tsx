...
const LazyFanOutDiagram = lazy(() =>
  import("./ArchitectureDiagramR3F").then((m) => ({
    default: m.FanOutDiagram,
  })),
);
const LazyJITStreamingDiagram = lazy(() =>
  import("./ArchitectureDiagramR3F").then((m) => ({
    default: m.JITStreamingDiagram,
  })),
);
...
function SplitDiagram() {
  ...
  return (
    ...
    >
      ...
      {/* Diamond */}
      <polygon
        points="190,52 200,62 190,72 180,62"
        fill="var(--card-bg)"
        stroke="var(--ink-black)"
        strokeWidth={2}
      />
...
function ArchitectureDiagram() {
  return (
    <div className="grid md:grid-cols-2 gap-6">
      <DiagramCard
        title="THE SPLIT"
        subtitle="Same code, two execution paths"
        color="var(--ink-black)"
        span
      >
        <SplitDiagram />
      ...
      <DiagramCard
        ...
        subtitle="Instant feedback in the browser"
      ...
      <DiagramCard
        ...
        subtitle="Production video at scale"
      ...
      <DiagramCard
        title="JIT STREAMING"
        subtitle="Media on demand, no ingestion"
      ...
      <DiagramCard
        ...
        subtitle="Split, process, recombine"
        color="var(--poster-blue)"
        span
      >
        <FanOutDiagram />
      ...
      <DiagramCard
        title="JIT STREAMING PLAYBACK"
        subtitle="On-demand transcoding, zero wait"
        color="var(--poster-red)"
        span
      >
        <JITStreamingDiagram />
      ...
      <DiagramCard
        ...
        subtitle="Export video without a server"
