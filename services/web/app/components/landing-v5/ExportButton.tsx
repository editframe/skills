  ...
  return (
    <button
      ...
      className={`
        ...
        ${queued ? "bg-[var(--poster-blue)]" : "hover:brightness-125"}
    ...
    >
      {queued ? (
        ...
        <>
          ...
          <svg
            className="w-4 h-4 text-[var(--poster-blue)]"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            strokeWidth={2}
      ...
      {!compact && !queued && (
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-[var(--poster-blue)]" />
      )}
    </button>
  );
}
