...
const tools = [
  ...
  },
  {
    ...
    icon: MusicNote,
    description:
      "Subtitle a video programmatically or with an SRT file of your choice.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p className="text-sm sm:text-md mt-2 sm:mt-4 text-gray-800 dark:text-gray-200">
        Welcome to the Editframe Tools section. Explore our powerful video
        editing tools. {tools.length} tools available.
      </p>
