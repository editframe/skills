...
export function GettingStartedSection() {
  return (
    <section className="relative py-24 bg-[var(--card-bg)] border-t-4 border-[var(--ink-black)] dark:border-white overflow-hidden">
      ...
      <div
        className="absolute top-1/2 left-0 -translate-y-1/2 -translate-x-1/3 w-[400px] h-[400px] opacity-[0.05] dark:opacity-[0.03]"
        aria-hidden="true"
      >
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-[var(--warm-gray)] mb-10">
              One command to scaffold. One command to develop. Hot reload that
              works.
            </p>
              ...
              {[
                {
                  ...
                  desc: "One command. Pick a template. Start building.",
                },
                {
                  num: "2",
                  title: "Start developing",
                  desc: "Dev server with instant preview. Edit code, see video update.",
                },
                {
                  num: "3",
                  title: "Render & deploy",
                  desc: "Render locally, in-browser, or push to the cloud.",
                },
              ].map((step, i) => (
                <div
                  key={i}
                  className="flex gap-4 py-4 border-b-2 border-[var(--ink-black)]/10 dark:border-white/10 last:border-b-0"
                >
                  <div className="flex-shrink-0 w-10 h-10 bg-[var(--poster-red)] flex items-center justify-center text-white font-black">
                    {step.num}
                  </div>
                  <div>
                    <h3 className="font-bold uppercase tracking-wider text-sm mb-1 text-[var(--ink-black)] dark:text-white">
                      {step.title}
                    </h3>
