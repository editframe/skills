...
const TemplatedRenderingDemo = lazy(() =>
  import("../TemplatedRenderingDemo").then((m) => ({
    default: m.TemplatedRenderingDemo,
  })),
);
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 bg-black dark:bg-white flex items-center justify-center">
              <span className="text-[var(--poster-gold)] dark:text-[#3a2e1a] text-xl font-black">
                &times;
              </span>
            </div>
          ...
          <p className="text-lg text-black/70 dark:text-white/70 max-w-2xl">
            Define your video once. Pass different data via CLI or API. Render
            thousands of personalized videos automatically.
          </p>
        </div>
