  ...
  return (
    <div className="border-b border-gray-700/20 last:border-0">
      <button
        ...
        className="w-full flex items-center justify-between px-2.5 py-1 text-[11px] font-semibold text-gray-200 hover:bg-gray-750/30 active:bg-gray-750/50 transition-all"
      >
