...
export function CodeExamplesSection() {
  return (
    <section className="relative py-24 bg-[var(--card-dark-bg)] text-white overflow-hidden">
      ...
      <div
        className="absolute top-1/2 left-0 -translate-y-1/2 -translate-x-1/4 text-[400px] font-black text-white/[0.03] leading-none select-none pointer-events-none"
        aria-hidden="true"
      >
        {"{"}
      </div>
      <div
        className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/4 text-[400px] font-black text-white/[0.03] leading-none select-none pointer-events-none"
        aria-hidden="true"
      >
        {"}"}
      </div>
        ...
        <div className="flex items-start gap-6 mb-16">
          ...
          <div>
            ...
            <p className="text-xl text-white/70 max-w-xl">
              HTML and CSS are the foundation. Add scripting for animation. Use
              React when you want components. No proprietary system to learn.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            {[
              ...
              <div key={i} className="bg-white/5 border border-white/10 p-6">
                ...
                <h3 className="text-sm font-bold uppercase tracking-wider mb-2 text-white">
                  {item.title}
                </h3>
