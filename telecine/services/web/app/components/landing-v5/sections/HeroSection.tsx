...
const HeroDemo = lazy(() =>
  import("../HeroDemo").then((m) => ({ default: m.HeroDemo })),
);
...
export function HeroSection() {
  ...
  return (
    <section className="relative pt-24 pb-20 bg-[var(--paper-cream)] texture-paper overflow-hidden">
      ...
      <div
        className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/3 w-[700px] h-[700px] opacity-[0.07] dark:opacity-[0.05]"
        aria-hidden="true"
      >
      ...
      <div className="relative max-w-5xl mx-auto px-6">
        ...
        <div className="relative mb-8">
          <div
            className="absolute -bottom-3 -right-3 md:-bottom-4 md:-right-4 w-full h-full bg-[var(--poster-blue)]"
            aria-hidden="true"
          />
          <div
            className="absolute -bottom-1.5 -right-1.5 md:-bottom-2 md:-right-2 w-full h-full bg-[var(--poster-gold)]"
            aria-hidden="true"
          />
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/20 transition-opacity">
                  <div className="w-16 h-16 rounded-full bg-white/90 flex items-center justify-center shadow-lg">
                    <svg
                      className="w-7 h-7 text-[var(--poster-red)] ml-1"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                    >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <div className="bg-[var(--poster-red)] px-5 py-3 font-mono text-sm flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={() =>
                navigator.clipboard?.writeText("npm create @editframe@latest")
              }
