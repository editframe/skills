...
import { generateAnimationStrings, formatAnimationStringForElement } from "../animationCSS";
...
export function generateAnimationStyle(
  ...
  const formattedStrings = animationStrings.map(formatAnimationStringForElement);
