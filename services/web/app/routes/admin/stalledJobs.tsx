...
export const loader = async ({ request, params }: Route.LoaderArgs) => {
  ...
  const jobs = await queue.getStalledJobs(offset, limit);
    ...
    <Button
      ...
      onConfirm={() => {
        fetcher.submit(
          ...
          {
            method: "POST",
            action: `/admin/queues/${queueName}/jobs/release-all-stalled`,
          },
        );
      }}
      disabled={isLoading}
    ...
    <Button
      ...
      onConfirm={() => {
        fetcher.submit(
          ...
          {
            method: "POST",
            action: `/admin/queues/${queueName}/jobs/delete-all-stalled`,
          },
        );
      }}
      disabled={isLoading}
